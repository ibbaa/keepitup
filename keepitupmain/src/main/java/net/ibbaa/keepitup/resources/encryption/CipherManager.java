...
public class CipherManager {
    ...
    public EncryptionResult encrypt(Map<String, String> kdfAlgorithmParam, Map<String, String> cipherAlgorithmParam, String password, String aad) {
        Log.d(CipherManager.class.getName(), "encrypt for KDF algorithm " + kdfAlgorithmParam.toString() + ", cipher algorithm " + cipherAlgorithmParam + ", password " + password + ", aad " + aad);
