...
public class SettingsInput {
    ...
    public enum Type {
        ...
        MATCHADDRESS(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_URI | InputType.TYPE_TEXT_FLAG_MULTI_LINE | InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS),
        MATCHPORT(InputType.TYPE_CLASS_NUMBER),
        RESOLVEADDRESS(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_URI | InputType.TYPE_TEXT_FLAG_MULTI_LINE | InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS),
        RESOLVEPORT(InputType.TYPE_CLASS_NUMBER);
