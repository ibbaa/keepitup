...
public class NullNetworkTaskValidator implements NetworkTaskValidator {

    private final Context context;

    public NullNetworkTaskValidator(Context context) {
        this.context = context;
    }

    @Override
    public ValidationResult validateAddress(String address) {
        Log.d(NullNetworkTaskValidator.class.getName(), "validateAddress, address is " + address);
    ...
    public ValidationResult validatePort(String port) {
        Log.d(NullNetworkTaskValidator.class.getName(), "validatePort, port is " + port);
    ...
    public ValidationResult validateInterval(String interval) {
        Log.d(NullNetworkTaskValidator.class.getName(), "validateInterval, interval is " + interval);
