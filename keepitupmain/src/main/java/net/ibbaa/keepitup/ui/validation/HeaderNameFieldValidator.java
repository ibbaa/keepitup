...
public class HeaderNameFieldValidator extends BaseStringValidator implements FieldValidator {

    public HeaderNameFieldValidator(String field, Context context) {
        super(field, context);
    }
    ...
    public ValidationResult validate(String value) {
        ...
        if (!HTTPUtil.validateHeaderName(value.trim())) {
            Log.d(HeaderNameFieldValidator.class.getName(), "Value has invalid characters. Validation failed.");
