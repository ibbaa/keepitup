...
public class NetworkTaskValidatorErrorDialog extends DialogFragment {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        Log.d(NetworkTaskValidatorErrorDialog.class.getName(), "onCreate");
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        Log.d(NetworkTaskValidatorErrorDialog.class.getName(), "onCreateView");
        View view = inflater.inflate(R.layout.dialog_network_task_validator_error, container);
    ...
    private void onOkClicked(@SuppressWarnings("unused") View view) {
        Log.d(NetworkTaskValidatorErrorDialog.class.getName(), "onOkClicked");
        dismiss();
    }
}
