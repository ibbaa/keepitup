...
public class NullResolveValidatorTest {

    private NullResolveValidator validator;

    @Before
    public void beforeEachTestMethod() {
        validator = new NullResolveValidator(TestRegistry.getContext());
    }
    ...
    public void testValidate() {
        ...
        result = validator.validateTargetPort("23");
        assertFalse(result.isValidationSuccessful());
