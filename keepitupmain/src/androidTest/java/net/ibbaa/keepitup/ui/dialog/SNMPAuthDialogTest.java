...
public class SNMPAuthDialogTest extends BaseUITest {
    ...
    public void testDefaultValues() {
        ...
        onView(withId(R.id.edittext_dialog_snmp_auth_snmp_auth_passphrase)).check(matches(withEffectiveVisibility(Visibility.GONE)));
        ...
        onView(withId(R.id.edittext_dialog_snmp_auth_snmp_priv_passphrase)).check(matches(withEffectiveVisibility(Visibility.GONE)));
        onView(withId(R.id.textview_dialog_snmp_auth_snmp_priv_algorithm_label)).check(matches(withText("Privacy algorithm")));
        onView(withId(R.id.spinner_dialog_snmp_auth_snmp_priv_algorithm)).check(matches(withEffectiveVisibility(Visibility.GONE)));
    ...
    public void testInitialValues() {
        ...
        onView(withId(R.id.edittext_dialog_snmp_auth_snmp_auth_passphrase)).check(matches(withEffectiveVisibility(Visibility.VISIBLE)));
        ...
        onView(withId(R.id.edittext_dialog_snmp_auth_snmp_priv_passphrase)).check(matches(withEffectiveVisibility(Visibility.VISIBLE)));
        onView(withId(R.id.spinner_dialog_snmp_auth_snmp_priv_algorithm)).check(matches(withSpinnerText("AES-192")));
        onView(withId(R.id.spinner_dialog_snmp_auth_snmp_priv_algorithm)).check(matches(withEffectiveVisibility(Visibility.VISIBLE)));
