...
public class SuspensionIntervalsDialogTest extends BaseUITest {
    ...
    public void testIntervalAddCancel() {
        ...
        onView(withId(R.id.picker_dialog_suspension_interval_add_time_hour)).check(matches(withValue(4)));
        onView(withId(R.id.picker_dialog_suspension_interval_add_time_minute)).check(matches(withValue(0)));
    ...
    public void testThreeIntervalsAdd() {
        ...
        onView(withId(R.id.imageview_dialog_suspension_interval_add_ok)).perform(click());
        onView(withId(R.id.textview_dialog_suspension_interval_add_time_label)).check(matches(withText("End")));
        onView(withId(R.id.picker_dialog_suspension_interval_add_time_hour)).check(matches(withValue(5)));
    ...
    public void testThreeIntervalsAddError() {
        ...
        onView(withId(R.id.picker_dialog_suspension_interval_add_time_minute)).check(matches(withValue(3)));
        onView(withId(R.id.picker_dialog_suspension_interval_add_time_hour)).perform(setNumber(3));
        onView(withId(R.id.picker_dialog_suspension_interval_add_time_minute)).perform(setNumber(4));
        onView(withId(R.id.imageview_dialog_suspension_interval_add_ok)).perform(click());
        onView(withId(R.id.textview_dialog_validator_error_title)).check(matches(withText("Validation failed")));
    ...
    public void testThreeIntervalsAddOverlap() {
        ...
        onView(withId(R.id.imageview_dialog_suspension_intervals_interval_add)).perform(click());
        onView(withId(R.id.textview_dialog_suspension_interval_add_time_label)).check(matches(withText("Start")));
        onView(withId(R.id.picker_dialog_suspension_interval_add_time_hour)).check(matches(withValue(1)));
        onView(withId(R.id.picker_dialog_suspension_interval_add_time_minute)).check(matches(withValue(15)));
        onView(withId(R.id.imageview_dialog_suspension_interval_add_ok)).perform(click());
        onView(withId(R.id.textview_dialog_suspension_interval_add_time_label)).check(matches(withText("End")));
