...
public class SettingsInputTest {
    ...
    public void testToBundle() {
        ...
        settingsInput = new SettingsInput(SettingsInput.Type.INTERVAL, "xyz", "testfield", 8, Collections.singletonList("1"));
        bundle = settingsInput.toBundle();
        settingsInput = new SettingsInput(bundle);
        ...
        settingsInput = new SettingsInput(SettingsInput.Type.CONNECTCOUNT, "test", "testfield", 1, Arrays.asList("abc", "def"));
        bundle = settingsInput.toBundle();
        settingsInput = new SettingsInput(bundle);
        ...
        assertEquals(1, settingsInput.getPosition());
        assertThat(settingsInput.getValidators(), is(Arrays.asList("abc", "def")));
        settingsInput = new SettingsInput(SettingsInput.Type.PINGPACKAGESIZE, "test", "testfield", 1, Arrays.asList("1", "1"));
        bundle = settingsInput.toBundle();
        settingsInput = new SettingsInput(bundle);
        ...
        assertEquals(-1, settingsInput.getPosition());
        assertThat(settingsInput.getValidators(), is(Arrays.asList("1", "1")));
        settingsInput = new SettingsInput(SettingsInput.Type.TASKNAME, "test", "testfield", 3, Arrays.asList("1", "1"));
        bundle = settingsInput.toBundle();
        settingsInput = new SettingsInput(bundle);
