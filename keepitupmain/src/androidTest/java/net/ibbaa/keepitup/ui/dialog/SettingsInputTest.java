...
public class SettingsInputTest {
    ...
    public void testToBundle() {
        ...
        assertEquals(3, settingsInput.getPosition());
        assertThat(settingsInput.getValidators(), is(Arrays.asList("1", "1")));
        settingsInput = new SettingsInput(SettingsInput.Type.MATCHADDRESS, "test", "test", "testfield", 3, Arrays.asList("1", "1"));
        bundle = settingsInput.toBundle();
        settingsInput = new SettingsInput(bundle);
        assertEquals(SettingsInput.Type.MATCHADDRESS, settingsInput.getType());
        assertEquals(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_URI | InputType.TYPE_TEXT_FLAG_MULTI_LINE | InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS, Objects.requireNonNull(settingsInput.getType()).getInputType());
        assertEquals("test", settingsInput.getTitle());
        assertEquals("test", settingsInput.getValue());
        assertEquals("testfield", settingsInput.getField());
        assertEquals(3, settingsInput.getPosition());
        assertThat(settingsInput.getValidators(), is(Arrays.asList("1", "1")));
        settingsInput = new SettingsInput(SettingsInput.Type.MATCHPORT, "test", "testfield", Arrays.asList("1", "1"));
        bundle = settingsInput.toBundle();
        settingsInput = new SettingsInput(bundle);
        assertEquals(SettingsInput.Type.MATCHPORT, settingsInput.getType());
        assertEquals(InputType.TYPE_CLASS_NUMBER, Objects.requireNonNull(settingsInput.getType()).getInputType());
        assertEquals("test", settingsInput.getValue());
        assertEquals("testfield", settingsInput.getField());
        assertEquals(-1, settingsInput.getPosition());
        assertThat(settingsInput.getValidators(), is(Arrays.asList("1", "1")));
        settingsInput = new SettingsInput(SettingsInput.Type.RESOLVEADDRESS, "test", "test", "testfield", 3, Arrays.asList("1", "1"));
        bundle = settingsInput.toBundle();
        settingsInput = new SettingsInput(bundle);
        assertEquals(SettingsInput.Type.RESOLVEADDRESS, settingsInput.getType());
        assertEquals(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_URI | InputType.TYPE_TEXT_FLAG_MULTI_LINE | InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS, Objects.requireNonNull(settingsInput.getType()).getInputType());
        assertEquals("test", settingsInput.getTitle());
        assertEquals("test", settingsInput.getValue());
        assertEquals("testfield", settingsInput.getField());
        assertEquals(3, settingsInput.getPosition());
        assertThat(settingsInput.getValidators(), is(Arrays.asList("1", "1")));
        settingsInput = new SettingsInput(SettingsInput.Type.RESOLVEPORT, "test", "testfield", Arrays.asList("1", "1"));
        bundle = settingsInput.toBundle();
        settingsInput = new SettingsInput(bundle);
        assertEquals(SettingsInput.Type.RESOLVEPORT, settingsInput.getType());
        assertEquals(InputType.TYPE_CLASS_NUMBER, Objects.requireNonNull(settingsInput.getType()).getInputType());
        assertEquals("test", settingsInput.getValue());
        assertEquals("testfield", settingsInput.getField());
        assertEquals(-1, settingsInput.getPosition());
