...
public class ResolvePortMatchFieldValidatorTest {

    @Test
    public void testValidate() {
        ResolvePortMatchFieldValidator validator = new ResolvePortMatchFieldValidator("testport", TestRegistry.getContext());
