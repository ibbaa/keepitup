...
public class ConstantPreferenceManagerTest {

    private ConstantPreferenceManager constantPreferenceManager;
    private PreferenceManager preferenceManager;

    @Before
    public void beforeEachTestMethod() {
        constantPreferenceManager = new ConstantPreferenceManager(TestRegistry.getContext());
