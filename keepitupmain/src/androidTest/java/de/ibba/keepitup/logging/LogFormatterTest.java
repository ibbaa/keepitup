...
public class LogFormatterTest {
    ...
    public void testExceptionToString() {
        ...
        assertTrue(exc.contains("at de.ibba.keepitup.logging.LogFormatterTest.testExceptionToString"));
    ...
    public void testFormatLogFileEntry() {
        ...
        try {
            ...
            assertTrue(message.contains("at de.ibba.keepitup.logging.LogFormatterTest.testFormatLogFileEntry"));
            assertArrayEquals(message.getBytes(Charsets.UTF_8), logFormatter.formatLogFileEntry(entry, Charsets.UTF_8));
        }
    }
