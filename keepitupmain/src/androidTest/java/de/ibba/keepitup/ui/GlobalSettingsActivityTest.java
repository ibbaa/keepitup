...
public class GlobalSettingsActivityTest extends BaseUITest {
    ...
    public void testDisplayDefaultValues() {
        ...
        onView(withId(R.id.textview_global_settings_activity_external_storage_type_label)).check(matches(withText("External storage type")));
        onView(withId(R.id.radiogroup_global_settings_activity_external_storage_type)).check(matches(hasChildCount(2)));
        onView(withId(R.id.radiobutton_global_settings_activity_external_storage_type_primary)).check(matches(withText("Primary")));
        onView(withId(R.id.radiobutton_global_settings_activity_external_storage_type_sdcard)).check(matches(withText("SD card")));
        onView(withId(R.id.radiobutton_global_settings_activity_external_storage_type_primary)).check(matches(isChecked()));
        onView(withId(R.id.radiobutton_global_settings_activity_external_storage_type_sdcard)).check(matches(not(isChecked())));
        onView(withId(R.id.radiobutton_global_settings_activity_external_storage_type_primary)).check(matches(not(isEnabled())));
        onView(withId(R.id.radiobutton_global_settings_activity_external_storage_type_sdcard)).check(matches(not(isEnabled())));
        ...
        onView(withId(R.id.textview_global_settings_activity_log_folder)).check(matches(withText(endsWith("log"))));
        onView(withId(R.id.textview_global_settings_activity_log_folder)).check(matches(not(isEnabled())));
    }
    ...
    public void testDisplayValues() {
        ...
        onView(withId(R.id.radiobutton_global_settings_activity_external_storage_type_primary)).check(matches(withText("Primary")));
        onView(withId(R.id.radiobutton_global_settings_activity_external_storage_type_sdcard)).check(matches(withText("SD card")));
        onView(withId(R.id.radiobutton_global_settings_activity_external_storage_type_primary)).check(matches(not(isChecked())));
        onView(withId(R.id.radiobutton_global_settings_activity_external_storage_type_sdcard)).check(matches(isChecked()));
        onView(withId(R.id.radiobutton_global_settings_activity_external_storage_type_primary)).check(matches(isEnabled()));
        onView(withId(R.id.radiobutton_global_settings_activity_external_storage_type_sdcard)).check(matches(isEnabled()));
        onView(withId(R.id.textview_global_settings_activity_download_folder_label)).check(matches(withText("Download folder")));
    ...
    public void testSwitchYesNoText() {
        ...
        onView(withId(R.id.switch_global_settings_activity_file_dump_enabled)).perform(scrollTo());
        onView(withId(R.id.switch_global_settings_activity_file_dump_enabled)).check(matches(isNotChecked()));
        onView(withId(R.id.textview_global_settings_activity_file_dump_enabled_on_off)).check(matches(withText("no")));
        onView(withId(R.id.switch_global_settings_activity_file_dump_enabled)).perform(click());
        onView(withId(R.id.switch_global_settings_activity_file_dump_enabled)).check(matches(isChecked()));
    ...
    public void testExternalStorageType() {
        ...
        onView(withId(R.id.radiobutton_global_settings_activity_external_storage_type_sdcard)).check(matches(isEnabled()));
        assertEquals(0, preferenceManager.getPreferenceExternalStorageType());
        String downloadPrimary = getText(withId(R.id.textview_global_settings_activity_download_folder));
        ...
        onView(withId(R.id.radiobutton_global_settings_activity_external_storage_type_sdcard)).perform(click());
        assertEquals(1, preferenceManager.getPreferenceExternalStorageType());
        String downloadSDCard = getText(withId(R.id.textview_global_settings_activity_download_folder));
        ...
        onView(withId(R.id.imageview_dialog_folder_choose_cancel)).perform(click());
        onView(withId(R.id.radiobutton_global_settings_activity_external_storage_type_primary)).perform(click());
        assertEquals(0, preferenceManager.getPreferenceExternalStorageType());
        String downloadPrimary2 = getText(withId(R.id.textview_global_settings_activity_download_folder));
        onView(withId(R.id.textview_global_settings_activity_download_folder)).perform(click());
